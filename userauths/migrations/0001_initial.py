    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('joining_comments', django_ckeditor_5.fields.CKEditor5Field(blank=True, null=True)),
            ],
        ),
        migrations.CreateModel(
            name='User',
            fields=[
                ...
                ('gender', models.CharField(blank=True, choices=[('female', 'Female'), ('male', 'Male'), ('non-binary', 'Non-binary'), ('prefer_not_to_say', 'Prefer not to say')], max_length=100, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('website_url', models.URLField(blank=True, max_length=100)),
                ('joining_comments', models.TextField(blank=True, max_length=2000)),
                ('emergency_contact', models.CharField(blank=True, max_length=100, null=True)),
                ('emergency_contact_phone', models.CharField(blank=True, max_length=13, null=True)),
                ...
                ('identity_type', models.CharField(blank=True, choices=[('drivers_licence', 'Drivers Licence'), ('international_passport', 'International Passport')], default='drivers_license', max_length=100, null=True)),
